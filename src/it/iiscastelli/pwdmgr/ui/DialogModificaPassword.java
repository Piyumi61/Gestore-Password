...
public class DialogModificaPassword extends javax.swing.JDialog {
    ...
    public void setCredenziali(Credenziali credenziali) {
        ...
        txtPassword.setText(credenziali.getPassword());
        pwdPassword.setText(credenziali.getPassword());
        valutaComplessita();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogModificaPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogModificaPassword dialog = new DialogModificaPassword(new javax.swing.JFrame(), true);
